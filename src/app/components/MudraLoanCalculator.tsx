...
const MudraLoanCalculator: React.FC = () => {
  const [loanAmount, setLoanAmount] = useState(50000); // ₹50,000
  const [interestRate, setInterestRate] = useState(10); // in %
  ...
  return (
    <section className="max-w-xl mx-auto bg-white rounded-xl shadow-md p-8 mt-10">
      <h2 className="text-2xl font-bold text-green-700 mb-6">Mudra Loan EMI Calculator</h2>
      ...
      <div className="mt-8 bg-green-50 rounded-lg p-6">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex justify-between">
            ...
            <span className="font-bold text-green-700">₹{emi.toLocaleString()}</span>
          </div>
          <div className="flex justify-between">
...
export default MudraLoanCalculator; 