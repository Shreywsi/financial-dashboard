...
const CarEmiCalculator: React.FC = () => {
  const [loanAmount, setLoanAmount] = useState(500000); // ₹5 Lakh
  const [interestRate, setInterestRate] = useState(9.5); // in %
  ...
  return (
    <section className="max-w-xl mx-auto bg-white rounded-xl shadow-md p-8 mt-10">
      <h2 className="text-2xl font-bold text-blue-700 mb-6">Car Loan EMI Calculator</h2>
      ...
      <div className="mt-8 bg-blue-50 rounded-lg p-6">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex justify-between">
            ...
            <span className="font-bold text-blue-700">₹{emi.toLocaleString()}</span>
          </div>
          <div className="flex justify-between">
